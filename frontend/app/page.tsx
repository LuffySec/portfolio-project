  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-violet-600/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            Membangun antarmuka yang responsif dan interaktif. Berpengalaman melalui project nyata dan terus belajar teknologi terbaru.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/portfolio" className="px-8 py-3 rounded-xl bg-indigo-600 text-white font-medium hover:bg-indigo-700 transition-colors duration-300 w-full sm:w-auto">
              Lihat Portofolio
            </Link>
            <Link href="/contact" className="px-8 py-3 rounded-xl bg-gray-800 text-white font-medium hover:bg-gray-700 transition-colors duration-300 w-full sm:w-auto border border-gray-700">
              Hubungi Saya
            </Link>
          </div>
        </div>
        ...
        <div className="mt-24 grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-gray-900/50 border border-gray-800 hover:border-indigo-500/50 transition-all duration-300 hover:-translate-y-1 group">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">Membangun antarmuka web yang responsif dan interaktif menggunakan React, Next.js, dan Tailwind CSS.</p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-gray-900/50 border border-gray-800 hover:border-violet-500/50 transition-all duration-300 hover:-translate-y-1 group">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">Mengembangkan API dan server-side logic menggunakan Express.js dan mengelola database MySQL.</p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-gray-900/50 border border-gray-800 hover:border-purple-500/50 transition-all duration-300 hover:-translate-y-1 group">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">Mendesain pengalaman pengguna yang intuitif dan tampilan visual yang modern dan menarik.</p>
          </div>
        </div>
      </div>
    </div>
