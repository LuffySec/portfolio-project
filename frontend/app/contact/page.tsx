    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
          Hubungi <span className="bg-gradient-to-r from-indigo-400 to-violet-400 bg-clip-text text-transparent">Saya</span>
        </h1>
          ...
          <div className="p-8 rounded-2xl bg-gray-900/50 border border-gray-800">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-lg bg-gray-800 flex items-center justify-center text-indigo-400 shrink-0">📍</div>
                <div>
                  <h4 className="text-white font-medium">Alamat</h4>
                  <p className="text-gray-400 text-sm mt-1">Makassar, Sulawesi Selatan, Indonesia</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-lg bg-gray-800 flex items-center justify-center text-indigo-400 shrink-0">✉️</div>
                <div>
                  <h4 className="text-white font-medium">Email</h4>
                  <p className="text-gray-400 text-sm mt-1">hello@portofolio.com</p>
                </div>
              </div>
            </div>
          </div>
