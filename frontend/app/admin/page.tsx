...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Welcome Banner */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-900/40 via-violet-900/30 to-purple-900/20 border border-indigo-500/20 p-8 sm:p-10">
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 text-sm font-medium mb-6">
            <span className="w-1.5 h-1.5 rounded-full bg-indigo-400 animate-pulse"></span> CMS Admin Panel v1.0
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="p-6 rounded-2xl bg-gray-900/50 border border-gray-800/60 space-y-4">
          ...
          <div className="space-y-2.5">
            <Link
              href="/admin/projects"
              className="flex items-center justify-between p-3.5 rounded-xl bg-gray-950/60 border border-gray-800/60 hover:border-indigo-500/40 group transition-colors"
            >
            ...
            <Link
              href="/admin/skills"
              className="flex items-center justify-between p-3.5 rounded-xl bg-gray-950/60 border border-gray-800/60 hover:border-amber-500/40 group transition-colors"
            >
              <div className="flex items-center gap-3">
                <span className="text-xl">⚡</span>
                <span className="font-medium text-gray-200 group-hover:text-white transition-colors">
            ...
            <Link
              href="/admin/certificates"
              className="flex items-center justify-between p-3.5 rounded-xl bg-gray-950/60 border border-gray-800/60 hover:border-emerald-500/40 group transition-colors"
            >
              <div className="flex items-center gap-3">
                <span className="text-xl">🎓</span>
                <span className="font-medium text-gray-200 group-hover:text-white transition-colors">
            ...
            <Link
              ...
              className="flex items-center justify-between p-3.5 rounded-xl bg-gray-950/60 border border-gray-800/60 hover:border-purple-500/40 group transition-colors"
            >
              <div className="flex items-center gap-3">
                <span className="text-xl">💬</span>
                <span className="font-medium text-gray-200 group-hover:text-white transition-colors">
          ...
          <div className="pt-4 mt-4 border-t border-gray-800/60">
            <div className="p-4 rounded-xl bg-indigo-500/10 border border-indigo-500/20 text-xs text-indigo-300 leading-relaxed">
              💡 <strong>Tips Pembelajaran:</strong> Pada pertemuan selanjutnya, kita akan membangun form pembuatan dan pengeditan data (CRUD) untuk masing-masing entitas.
            </div>
          </div>
        </div>
      </div>
