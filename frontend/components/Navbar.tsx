          ...
          <div className="md:hidden">
            ...
            >
              <div className="w-6 h-6 flex flex-col justify-center items-center relative">
                <span className={`block w-6 h-0.5 bg-current transition-all duration-300 absolute ${isOpen ? "rotate-45" : "-translate-y-2"}`}></span>
                <span className={`block w-6 h-0.5 bg-current transition-all duration-300 absolute ${isOpen ? "opacity-0" : "opacity-100"}`}></span>
                <span className={`block w-6 h-0.5 bg-current transition-all duration-300 absolute ${isOpen ? "-rotate-45" : "translate-y-2"}`}></span>
              </div>
            </button>
          </div>
